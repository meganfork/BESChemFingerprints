...
CP.tot.load<-sum(CP.Q.seq$Q_Ls*CP.tot.conc.med*300)/1e+09 
#Q measurements are every 5 mins; we estimate a total of 1.61 kg pharmaceuticals total enter the Bay from this one catchment without a WWTP
...
# mean(CP.zeros.MC$Amytriptyline)*(1000/75)+mean(CP.zeros.MC$Mianserin)*(1000/60)+mean(CP.zeros.MC$Sertraline)*(1000/50)+mean(CP.zeros.MC$Venlafaxine)*(1000/100)    is the equivalent of total antibiotics discharged (9301)
